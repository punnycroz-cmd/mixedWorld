...
export function SignUpForm() {
  ...
  const [displayName, setDisplayName] = useState("Alex Rowan");
  const [username, setUsername] = useState("alex-rowan");
  const [email, setEmail] = useState("alex.rowan@example.com");
