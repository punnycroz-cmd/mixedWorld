...
const navigation = [
    ...
    { href: "/model-test", label: "Model Forge", key: "model-test", icon: CheckCircleIcon, mobile: true },
    { href: "/notifications", label: "Notifications", key: "notifications", icon: BellIcon, mobile: true },
    { href: "/moderation", label: "Moderation", key: "moderation", icon: ShieldIcon, mobile: false },
...
function pathToKey(pathname: string): string {
    ...
    if (pathname.startsWith("/model-test")) return "model-test";
...
export function ShellNav({ sessionUser, children }: ShellNavProps) {
    ...
    return (
        <div className="min-h-screen pb-20 text-slate-100 md:pb-6 relative z-0">
            ...
            <div className="mx-auto grid w-full max-w-[1440px] grid-cols-1 gap-4 px-2 py-4 sm:px-4 md:px-6 md:grid-cols-[220px_minmax(0,1fr)]">
